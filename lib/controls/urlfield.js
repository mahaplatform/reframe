...
var Urlfield = function (_React$Component) {
  _inherits(Urlfield, _React$Component);
  ...
  _createClass(Urlfield, [{
    ...
    value: function render() {
      return _react2.default.createElement('input', { value: this.state.value, ref: 'control', onChange: this.handleChange.bind(this), type: 'text', name: this.props.code, id: this.props.code, placeholder: this.props.placeholder });
    }
  }, {
    key: 'handleChange',
