    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        !chosen && _react2.default.createElement(
          'div',
          { className: 'ui input' },
          _react2.default.createElement('input', { type: 'text', onFocus: this._handleBegin.bind(this), placeholder: prompt })
        ),
        _react2.default.createElement(
          _reactTransitionGroup.CSSTransition,
          { 'in': active, classNames: 'cover', timeout: 500, mountOnEnter: true, unmountOnExit: true },
          _react2.default.createElement(_search2.default, _extends({}, this._getSearch(), { key: 'search' }))
        ),
        _react2.default.createElement(
          _reactTransitionGroup.CSSTransition,
          ...
          _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(_form2.default, _extends({}, this._getForm(), { key: 'form' }))
          )
        )
      );
    }
