...
var Preview = function Preview(_ref) {
  ...
  return _react2.default.createElement(
    ...
    file.asset && false ? _react2.default.createElement('img', { src: '/imagecache/fit=cover&w=300&h=300' + file.asset.path, title: file.asset.original_file_name }) : _react2.default.createElement('div', { className: 'reframe-filefield-preview-image', style: { backgroundImage: 'url(\'' + preview + '\')' } }),
    file.asset && _react2.default.createElement(
      ...
      transforms && transforms.map(function (transform, index) {
        return dpis.map(function (dpi, index) {
