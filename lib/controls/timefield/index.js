...
var TimeField = function (_React$Component) {
  ...
  _createClass(TimeField, [{
    ...
    value: function _getOptions() {
      ...
      var startTime = (0, _moment2.default)(today + ' ' + start);

      var endTime = (0, _moment2.default)(today + ' 24:00');

      var steps = endTime.diff(startTime) / 1000 / 60 / 60 * (60 / increment);

      var currTime = (0, _moment2.default)(today + ' ' + start);

      return [].concat(_toConsumableArray(Array(steps))).reduce(function (times, i) {
