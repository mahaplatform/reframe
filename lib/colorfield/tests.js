...
describe('collection', function () {
  ...
  describe('component', function () {
    ...
    it('calls onSet', function () {
      ...
      var onSet = (0, _sinon.spy)();
      (0, _enzyme.mount)(_react2.default.createElement(_colorfield2.default, { defaultValue: 'red', onSet: onSet }));
    ...
    it('calls onReady', function () {
      ...
      (0, _enzyme.mount)(_react2.default.createElement(_colorfield2.default, { onReady: onReady }));
