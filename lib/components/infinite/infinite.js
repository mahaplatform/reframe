...
var Infinite = function (_React$Component) {
  ...
  _createClass(Infinite, [{
    ...
    value: function render() {
      ...
      var is_filtered = filter && Object.keys(filter).length > 0;
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      return ['all', 'cacheKey', 'exclude_ids', 'filter', 'records', 'sort', 'status', 'selected', 'total'].reduce(function (update, key) {
