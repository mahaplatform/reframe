...
var Infinite = function (_React$Component) {
  ...
  _createClass(Infinite, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      return ['all', 'cacheKey', 'filter', 'records', 'sort', 'status', 'selected', 'total'].reduce(function (update, key) {
    ...
    value: function _handleFetch() {
      ...
      }, filter ? { $filter: filter } : {}, sort && sort.key ? { $sort: (sort.order === 'desc' ? '-' : '') + sort.key } : {});
