    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'reframe-export-header-icon', onClick: this._handleDone.bind(this) },
            _react2.default.createElement('i', { className: 'fa fa-chevron-left' })
          ),
          _react2.default.createElement(
            'div',
            { className: 'reframe-export-header-title' },
            'Export Results'
          ),
          _react2.default.createElement('div', { className: 'reframe-export-header-icon' })
        ),
        _react2.default.createElement(
          'div',
