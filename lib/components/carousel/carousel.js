...
var Carousel = function (_React$Component) {
  ...
  _createClass(Carousel, [{
    ...
    value: function _getSlideClass(index) {
      ...
      var last = total - 1;
      var reached_end = curr === last && next === 0;
      var reached_beginning = curr === 0 && next === last;
      var right = next !== curr && (next === curr + 1 || reached_end);
      var left = next !== curr && (next === curr - 1 || reached_beginning);
