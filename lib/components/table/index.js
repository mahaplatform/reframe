          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              selectable && _react2.default.createElement(
                'td',
                { className: 'reframe-table-check-cell', onClick: this._handleSelectAll.bind(this) },
          ...
          _react2.default.createElement(
            ...
            records.map(function (record, rowIndex) {
              return _react2.default.createElement(
                ...
                selectable && _react2.default.createElement(
                  'td',
                  { key: 'cell_' + rowIndex + '_select', className: 'reframe-table-check-cell', onClick: _this2._handleSelect.bind(_this2, record.id) },
