...
var Form = function (_React$Component) {
  ...
  _createClass(Form, [{
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              !configuring && config.map(function (section, index) {
                return _react2.default.createElement(_section2.default, _extends({ key: 'section_' + index }, _this2._getSection(section, index)));
              })
            ),
    ...
    key: '_getSection',
    value: function _getSection(section, index) {
