...
var LookupPanel = function (_React$Component) {
  ...
  _createClass(LookupPanel, [{
    ...
    value: function _getValue(id) {
      ...
      if (_lodash2.default.includes(values[name], id)) return _lodash2.default.without(values[name], id);
      return [].concat(_toConsumableArray(values[name]), [id]);
    }
  }, {
    key: '_handleClick',
...
var Lookup = function (_React$Component2) {
  ...
  _createClass(Lookup, [{
    ...
    value: function _getLookupPanel() {
      ...
      return { format: format, label: label, multiple: multiple, name: name, options: options, values: values, onChange: onChange, onRemovePanel: onRemovePanel };
    }
  }]);
