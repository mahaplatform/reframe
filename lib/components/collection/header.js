...
var Header = function (_React$Component) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        filters && _react2.default.createElement(
          'div',
          { className: 'reframe-collection-header-filter', title: 'Filter Records', onClick: this._handleToggleMode.bind(this, 'filter') },
          _react2.default.createElement('i', { className: 'fa fa-sliders' }),
          count > 0 && _react2.default.createElement(
            'div',
            { className: 'reframe-collection-header-filter-count' },
            count
          )
        ),
        this.props.export && _react2.default.createElement(
          'div',
          { className: 'reframe-collection-header-export', title: 'Export Records', onClick: this._handleToggleMode.bind(this, 'export') },
    ...
    value: function _handleToggleMode(mode) {
