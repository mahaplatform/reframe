    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        filters && _react2.default.createElement(
          'div',
          { className: 'reframe-collection-header-icon', title: 'Filter Records', onClick: this._handleToggleFilter.bind(this) },
          _react2.default.createElement('i', { className: 'fa fa-sliders' })
        ),
        this.props.export && _react2.default.createElement(
          'div',
          { className: 'reframe-collection-header-icon', title: 'Export Records', onClick: this._handleExport.bind(this) },
