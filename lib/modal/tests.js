...
describe('modal component', function () {
  ...
  it('renders open with a component', function () {
    ...
    var modal = (0, _enzyme.mount)(_react2.default.createElement(_modal2.default, { component: component, open: true }));

    var panelComponent = modal.childAt(1).childAt(0);
  ...
  it('calls onClear', function (done) {
    ...
    var modal = (0, _enzyme.mount)(_react2.default.createElement(_modal2.default, { open: true, onClear: onClear }));
