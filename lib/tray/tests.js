...
describe('tray component', function () {
  ...
  it('renders open with a component', function () {
    ...
    var tray = (0, _enzyme.mount)(_react2.default.createElement(_tray2.default, { component: component, open: true }));

    var panelComponent = tray.childAt(1).childAt(0);
  ...
  it('calls onClear', function (done) {
    ...
    var tray = (0, _enzyme.mount)(_react2.default.createElement(_tray2.default, { open: true, onClear: onClear }));
