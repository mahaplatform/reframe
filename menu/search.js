...
var Search = function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function chooseResult(result, type) {
      ...
      if (route) {
        this.context.router.push(_lodash2.default.template(route, { interpolate: _config2.default.get('menu.search.urlInterpolate', _lodash2.default.templateSettings.interpolate) })(result));
      }
      this.refs.input.clear();
    }
  }]);
