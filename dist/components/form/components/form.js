  ...
  _createClass(Form, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          onValidateForm = _props2.onValidateForm,
          onResetForm = _props2.onResetForm;
      var _props$state = this.props.state,
          status = _props$state.status,
          sections = _props$state.sections,
    ...
    value: function componentDidUpdate(prevProps) {
      var _props$state2 = this.props.state,
          status = _props$state2.status,
          data = _props$state2.data;
    ...
    value: function _handleLoadSections() {
      var _props3 = this.props,
          ...
          onFetchSections = _props3.onFetchSections,
    ...
    value: function _collectData() {
      var _props$state3 = this.props.state,
          sections = _props$state3.sections,
          data = _props$state3.data;
