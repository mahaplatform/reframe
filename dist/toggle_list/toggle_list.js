      ...
      return function (_ref) {
        ...
        return _react2.default.createElement(
          ...
          records.map(function (record, index) {
            var checked = _lodash2.default.includes(chosen, record.id);
            return _react2.default.createElement(
              'div',
              { key: 'record' + index, className: 'reframe-search-result', onClick: _this2._handleToggle.bind(_this2, record.id) },
