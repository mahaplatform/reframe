  ...
  _createClass(Task, [{
    ...
    value: function render() {
      if (this.props.task.handler) {
        ...
        var target = this.props.task.target && this.props.task.target == 'blank' ? '_blank' : '_self';
        return _react2.default.createElement(
          'a',
        ...
        return _react2.default.createElement(
          ...
          { to: this.props.task.route, activeClassName: 'active', className: 'item' },
          this.props.task.label
        );
      } else if (this.props.task.link) {
        return _react2.default.createElement(
          _reactRouter.IndexLink,
          { to: this.props.task.link, activeClassName: 'active', className: 'item' },
          this.props.task.label
        );
      }
    }
