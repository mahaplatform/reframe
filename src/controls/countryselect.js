...
class Countryselect extends React.Component {
  ...
  render() {
    return (
      <div className="ui fluid search selection dropdown" ref="control">
        <input defaultValue={this.props.defaultValue} type="hidden" name="country" onChange={this.props.onChange} />
        <i className="dropdown icon"/>
        <div className="default text">Select Country</div>
        <div className="menu">
          <div className="item" data-value="us"><i className="us flag"/>United States</div>
          <div data-value="1" className="item">-------------</div>
