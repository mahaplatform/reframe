...
class Urlfield extends React.Component {
  ...
  render() {
    return <input value={this.state.value} ref="control" onChange={this.handleChange.bind(this)} type="text" name={this.props.code} id={this.props.code} placeholder={this.props.placeholder} />
  }
